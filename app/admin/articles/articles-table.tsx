        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-border">
              ...
              <th className="text-left px-6 py-3 text-xs uppercase tracking-wider text-muted-foreground font-normal hidden md:table-cell">Author</th>
              ...
              <th className="text-left px-6 py-3 text-xs uppercase tracking-wider text-muted-foreground font-normal hidden xl:table-cell">Featured</th>
            ...
            {filtered.length === 0 ? (
              ...
              filtered.map((a) => (
                <tr key={a.id} className="hover:bg-muted/30 transition-colors">
                  ...
                  <td className="px-6 py-4 text-muted-foreground hidden md:table-cell">{a.author ?? "—"}</td>
                  <td className="px-6 py-4 text-muted-foreground hidden lg:table-cell">{a.category}</td>
                  <td className="px-6 py-4 hidden xl:table-cell">
                    {a.featured && <Star className="w-4 h-4 text-yellow-400 fill-yellow-400" />}
                  </td>
                  <td className="px-6 py-4">
